...
public class Borrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("BORRAR PAIS");

        jLabelNombre.setText("Nombre del sitio");
        ...
        setSize(new java.awt.Dimension(381, 317));
    ...
    private void jButtonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBorrarActionPerformed
        ...
        if (jTextFieldNombre.getText().equals("")) {
            ...
            try {
                ...
                BufferedReader reader = new BufferedReader(new FileReader("Paises.txt"));  // Cargamos el fichero para lectura
                ...
                if (linea == null) {
                    ...
                    if (!encontrado) {
                        ...
                        BufferedWriter writer = new BufferedWriter(new FileWriter("Paises.txt"));
