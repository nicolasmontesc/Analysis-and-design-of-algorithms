...
import usb.Controlador.metodos;
...
public class Insertar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelNcontagiados = new javax.swing.JLabel();
        jLabelNmuertos = new javax.swing.JLabel();
        jTextFieldNombre = new javax.swing.JTextField();
        jTextFieldinfectados = new javax.swing.JTextField();
        jTextFieldmuertos = new javax.swing.JTextField();
        ...
        setTitle("Mis Password : Usb.vista.net");
        setResizable(false);

        jLabelTitulo.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabelTitulo.setText("NUEVAS PAIS");

        jLabelNombre.setText("Nombre");

        jLabelNcontagiados.setText("Num. Contagiados");

        jLabelNmuertos.setText("Num. muertos");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabelNcontagiados)
                            .addComponent(jLabelNmuertos))
                        .addGap(38, 38, 38)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldinfectados)
                            .addComponent(jTextFieldmuertos)))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNcontagiados)
                    .addComponent(jTextFieldinfectados, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNmuertos)
                    .addComponent(jTextFieldmuertos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonLimpiar)
                    .addComponent(jButtonAnadir))
    ...
    private void jButtonLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLimpiarActionPerformed
        ...
        jTextFieldinfectados.setText("");
        jTextFieldmuertos.setText("");
    ...
    private void jButtonAnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnadirActionPerformed
        ...
        if (jTextFieldNombre.getText().equals("") || jTextFieldinfectados.getText().equals("") || jTextFieldmuertos.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "ERROR: Faltan datos", "Mensaje de Error", JOptionPane.WARNING_MESSAGE);
            return;
        }

        nuevoItem = jTextFieldNombre.getText() + " " + jTextFieldinfectados.getText() + " " + jTextFieldmuertos.getText();
        contraseñasGuardar.add(nuevoItem);
        jTextPaneVer.setText(jTextPaneVer.getText() + nuevoItem);
        metodos.guardar(nuevoItem);
    ...
    private javax.swing.JLabel jLabelNcontagiados;
    private javax.swing.JLabel jLabelNmuertos;
    private javax.swing.JLabel jLabelNombre;
    private javax.swing.JLabel jLabelTitulo;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JTextField jTextFieldNombre;
    private javax.swing.JTextField jTextFieldinfectados;
    private javax.swing.JTextField jTextFieldmuertos;
